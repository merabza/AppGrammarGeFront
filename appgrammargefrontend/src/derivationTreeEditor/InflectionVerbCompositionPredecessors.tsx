...
import type { VerbInflectionModel } from "./TypesAndSchemas/InflectionDataTypeAndSchema";
import type { inflectionVerbCompositionPredecessorsModel } from "./TypesAndSchemas/InflectionVerbCompositionDataTypeAndSchema";
...
> = (props) => {
    ...
    const { rootsRepo, memoVerbsDict, verbsForDropdownloading } =
                ...
                return (
                    <div key={index}>
                        <Form.Group
                            className="mb-1"
                            as={Row}
                            controlId={`pred[${index}]`}
                        >
                            <Form.Label
                                column
                                sm="4"
                                className="text-right"
                            >{`წინაპარი ${index + 1}`}</Form.Label>
                            <Col sm="6">
                                <TextBoxAutoComplete
