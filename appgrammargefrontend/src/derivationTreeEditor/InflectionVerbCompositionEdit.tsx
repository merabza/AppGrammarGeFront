...
import type { MorphemeRange, classifierModel } from "../masterData/mdTypes";
import { useCheckLoadMdTables } from "../appcarcass/masterdata/masterDataHooks/useCheckLoadMdTables";
import {
    type InflectionVerbCompositionData,
    inflectionVerbCompositionDataSchema,
    type inflectionVerbCompositionPredecessorsModel,
...
const InflectionVerbCompositionEdit: FC = () => {
    ...
    //1. იდენტიფიკატორი
    const [curIvcIdVal, setCurIvcIdVal] = useState<number | undefined>(
        undefined
    );
    ...
    const verbCompositionLastRanges = morphemeRanges
        ...
        .map(function (item) {
            return {
                mrId: item.mrId,
                mrKeyName: `${item.mrKey}-${item.mrName}`,
            };
        });
                ...
                <div id="root-deriv-tree" className="editor-scroll">
                    ...
                    <Form onSubmit={handleSubmit}>
                        <EditorHeader
                            ...
                            EditedObjectName={
                                inflectionVerbCompositionResultName
                            }
                            workingOnDelete={
                                workingOnDeleteInflectionVerbComposition
                            }
                        ...
                        {userHasConfirmRight &&
                            frm.inflectionVerbComposition.recordStatusId !==
                                ...
                                <StatusConfirmRejectPart
                                    ...
                                    applier={
                                        frm.inflectionVerbComposition.applier
                                    }
                        ...
                        <div>
                            <OneComboBoxControl
                                ...
                                label="კლასიფიკატორი"
                                value={
                                    frm.inflectionVerbComposition.classifierId
                                }
                            ...
                            <InflectionVerbCompositionPredecessors
                                predecessors={
                                    frm.inflectionVerbCompositionPredecessors
                                }
                                ...
                                onPredecessorChange={(parentNom, item) => {
                                    ...
                                    let predByVerbComposition =
                                        newForm.inflectionVerbCompositionPredecessors.find(
                                            (pred) =>
                                                pred.parentNom === parentNom
                                        );
                                    if (item) {
                                        if (!predByVerbComposition) {
                                            predByVerbComposition =
                                                {} as inflectionVerbCompositionPredecessorsModel;
                                            predByVerbComposition.parentNom =
                                                parentNom;
                                            predByVerbComposition.parentInflectionId =
                                                item.itemId;
                                            predByVerbComposition.lastMorphemeRangeId =
                                                parentNom ? null : 3;
