...
import BaseLink, { type BaseLinkElement, getBaseHref } from "./BaseLink";
import TextBoxAutoComplete, {
    type ListElement,
    type listElementComponentProps,
} from "./TextBoxAutoComplete";
import { Link, useNavigate } from "react-router-dom";
import type { BaseLinkType } from "../redux/types/rootsTypes";
    ...
    return (
        <Nav>
            ...
            <TextBoxAutoComplete
                ...
                loadDropDown={(searchValue: string) =>
            ...
            <Button
                ...
                onClick={(e) => {
                    e.preventDefault();
                    if (baseSearchValue)
                        navigate(`/basesearch/${baseSearchValue}`);
                }}
            >
                ძებნა
                ...
                <Button
                    ...
                    onClick={(e) => {
                        ...
                        if (savedIssueDetailLine.issueId)
                            navigate(
                                `/issuework/${savedIssueDetailLine.issueId}`
                            );
                    }}
                >
                    სიაში დაბრუნება
