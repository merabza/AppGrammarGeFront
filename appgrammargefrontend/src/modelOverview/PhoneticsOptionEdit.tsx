...
import {
    type PhoneticsOptionEditFormData,
...
import type { PhoneticsOptionDetail } from "../masterData/mdTypes";
...
const PhoneticsOptionEdit: FC = () => {
    ...
    const [curPhoIdVal, setCurPhoIdVal] = useState<number | undefined>(
        undefined
    ); //1. იდენტიფიკატორი
    const [expandedActionIndex, setExpandedActionIndex] = useState<
        number | null
    >(null); //გახსნილი მოქმედების ნომერი
    ...
    function goDetailDown(frm: PhoneticsOptionEditFormData, index: number) {
            ...
            <Col sm="6">
                ...
                <Form onSubmit={handleSubmit}>
                                    ...
                                    return (
                                        <li key={index}>
                                            <OneEditDeleteButtons
                                                ...
                                                label={GetOnephoneticsOptionDetailDescription(
                                                    phod
                                                )}
                                                onEditClick={(e) => {
                                                    e.preventDefault();
                                                ...
                                                onDeleteClick={(e) => {
                                                    ...
                                                    newFrm.phoneticsOptionDetails.splice(
                                                        index,
                                                        1
                                                    );
                                                    setFormData(newFrm);
                    ...
                    {PhoneticsOptionsDataType.update && (
                        <OnePlusButton
                            onClick={(e) => {
                                ...
                                if (newPod) {
                                    newPod.phodActOrd =
                                        newFrm.phoneticsOptionDetails.length +
                                        1;
                    ...
                    <OneSaveCancelButtons
                        ...
                        savingNow={
                            creatingPhoneticsOption || updatingPhoneticsOption
                        }
                        onCloseClick={() => {
                            dispatch(clearAllAlerts());
                            navigate(-1); //goBack
