...
import {
    type NounParadigmFormulaFormData,
            ...
            <Col md="6">
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <OneSaveCancelButtons
                        ...
                        savingNow={
                            creatingNounParadigmFormula ||
                            updatingNounParadigmFormula
                        }
                        onCloseClick={() => {
                            dispatch(clearAllAlerts());
                            if (frm.nounParadigmFormula.nounParadigmId === 0)
                                navigate(-1);
                            navigate(
