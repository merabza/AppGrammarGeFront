...
const PhoneticsTypeEdit: FC = () => {
  ...
  const [curPhtIdVal, setCurPhtIdVal] = useState<number | undefined>(undefined); //1. იდენტიფიკატორი
  ...
  const tableNamesForClear = useMemo(
    () => ["phoneticsTypes", "phoneticsTypeProhibitions", "phoneticsChanges"],
    []
  );
  ...
  function handleSubmit(e: React.SyntheticEvent) {
    ...
    if (curPhtIdVal) updatePhoneticsType(currentForm);
    else createPhoneticsType(currentForm);
    clearUsedTables();
  }
  ...
  function goProhibitionDown(index: number) {
      ...
      <Col sm="6">
        ...
        <Form onSubmit={handleSubmit}>
          <EditorHeader
            ...
            EditedObjectName={
              frm && frm.phoneticsType && frm.phoneticsType.phtName
            ...
            onDelete={() => {
              if (!!curPhtIdVal) deletePhoneticsType(curPhtIdVal);
              clearUsedTables();
            }}
            ...
            frm.phoneticsOptionIds.map((poId, index) => {
              return (
                <OneComboBoxControl
                  ...
                  firstItem={{ id: 0, name: "აირჩიეთ ფონეტიკური ვარიანტი" }}
                  getError={getError}
                  onChangeValue={changeField}
                  onTrashButtonClick={() => {
                    const newFrm = { ...frm };
                  ...
                  return (
                    <li key={index}>
                      <OneEditDeleteButtons
                        ...
                        label={GetOnePhoneticsTypeProhibitionDescription(phtp)}
                        onEditClick={(e) => {
                          e.preventDefault();
                      ...
                      {expandedProhibitionIndex === index && (
                        <div>
                          <OneUpDownButtons
                            ...
                            enableUp={index > 0}
                            enableDown={
                              index < frm.phoneticsTypeProhibitions.length - 1
                            }
                            onUpClick={(e) => {
                              e.preventDefault();
                          ...
                          <OneComboBoxControl
                            ...
                            value={
                              frm.phoneticsTypeProhibitions[index].phtpProhId
                            }
                            dataMember={[
                              { id: 0, name: "იყოს" },
                              { id: 1, name: "იყოს ერთ-ერთი" },
                              { id: 2, name: "არ იყოს" },
                            ]}
                            valueMember="id"
                            displayMember="name"
                          ...
                          <OneComboBoxControl
                            ...
                            label="ორიენტაცია"
                            value={
                              frm.phoneticsTypeProhibitions[index].phtpOrient
                            }
                            dataMember={[
                              { id: 0, name: "ბოლოდან" },
                              { id: 1, name: "თავიდან" },
                          ...
                          <OneNumberControl
                            ...
                            value={
                              frm.phoneticsTypeProhibitions[index].phtpStart
                            }
                            getError={getError}
                            onChangeValue={changeField}
                            minv={0}
                          ...
                          <OneNumberControl
                            ...
                            value={
                              frm.phoneticsTypeProhibitions[index].phtpCount
                            }
                            getError={getError}
                            onChangeValue={changeField}
                            minv={1}
                          ...
                          <OneComboBoxControl
                            ...
                            label="ობიექტის ტიპი"
                            value={
                              frm.phoneticsTypeProhibitions[index].phtpObject
                            }
                            dataMember={[
                              { id: 0, name: "ბგერა" },
                              { id: 1, name: "ხმოვანი" },
                          ...
                          <OneTextControl
                            ...
                            label="სიმბოლოები"
                            value={frm.phoneticsTypeProhibitions[index].phtpNew}
                            getError={getError}
                            onChangeValue={changeField}
                          />
                        </div>
          ...
          <OneSaveCancelButtons
            ...
            savingNow={creatingPhoneticsType || updatingPhoneticsType}
            onCloseClick={() => {
              dispatch(clearAllAlerts());
              navigate(-1); //goBack
            }}
