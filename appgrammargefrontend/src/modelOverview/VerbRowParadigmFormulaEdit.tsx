...
import {
    type VerbParadigmFormulaFormData,
...
const VerbRowParadigmFormulaEdit: FC = () => {
    ...
    const tableNamesForClear = useMemo(
        () => [ETableName.VerbRowParadigmRows],
        []
    );
    ...
    useEffect(() => {
        ...
        if (formulaIdVal) {
            ...
            if (loadingVerbParadigmFormula || !verbParadigmFormulaForEdit)
                return;
            ...
            <Col md="6">
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <OneComboBoxControl
                        ...
                        value={
                            frm.verbParadigmFormula.verbPersonMarkerParadigmId
                        }
                        ...
                        firstItem={{
                            id: 0,
                            name: "აირჩიეთ პირის ნიშნების პარადიგმა",
                        }}
                    />
                    <OneStrongLabel
                        controlId="morphemes"
                    ...
                    <OneSaveCancelButtons
                        ...
                        savingNow={
                            creatingVerbParadigmFormula ||
                            updatingVerbParadigmFormula
                        }
                        onCloseClick={() => {
                            dispatch(clearAllAlerts());
                            navigate(
