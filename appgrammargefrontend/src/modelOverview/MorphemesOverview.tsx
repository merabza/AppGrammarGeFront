...
const MorphemesOverview: FC = () => {
    ...
    const morphemeGroupsSorted = useMemo(() => {
        ...
        return morphemeGroups2.sort((a, b) =>
            a.mogName.localeCompare(b.mogName)
        );
    }, [morphemeGroups]);
    ...
    return (
        <div>
            ...
            <h4>
                ...
                {morphemesDataType.create && (
                    <Link to={`/morphemeEdit`}> + </Link>
                )}
            </h4>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    {mrsf
                                        .sort(
                                            (a, b) =>
                                                a.mrPosition - b.mrPosition
                                        )
                                        .map((mr) => {
                                            return (
                                                <th key={mr.mrId.toString()}>
                                                    {mr.mrKey}
                                                </th>
                                            );
                                        })}
                                        ...
                                        <tr key={`${mog.mogId}${l}`}>
                                            ...
                                            {mrsf
                                                ...
                                                .map((mr) => {
                                                    ...
                                                    if (morpheme) {
                                                        let phoneticsTypeName =
                                                            null;
                                                        if (
                                                            morpheme.phoneticsTypeId
                                                        ) {
                                                            const phoneticsType =
                                                                phoneticsTypes.find(
                                                                    (f) =>
