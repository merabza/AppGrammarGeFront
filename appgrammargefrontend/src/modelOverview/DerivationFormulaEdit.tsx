      ...
      <Col md="6">
        ...
        <Form onSubmit={handleSubmit}>
          <EditorHeader
            ...
            EditedObjectName={
              frm && frm.derivationFormula && frm.derivationFormula.formulaName
          ...
          <OneComboBoxControl
            ...
            dataMember={derivationTypes.filter((f) => !f.drtAutomatic)}
            valueMember="drtId"
          ...
          <OneSaveCancelButtons
            ...
            savingNow={creatingDerivationFormula || updatingDerivationFormula}
            onCloseClick={() => {
              dispatch(clearAllAlerts());
              navigate(-1); //goBack
            }}
