    ...
    return (
        <div>
            ...
            <p>
                ...
                დაანგარიშება:
                <br />
                ზმნის მრავლობითობის ტიპი, ზმნის პირის პარადიგმა, ზმნის ტიპი,
                სერია, აქტანტების კომბინაცია.
                <br />
                ამ ინფორმაციის დასაანგარიშებლად გამოიყენება:
            </p>
            <ul>
                <li>
                    ზმნის მრავლობითობის, ზმნის ტიპისა და სერიების კომბინაცია.
                    რომელიც გვაძლევს ინფორმაციას საბოლოოდ რა მარვლობითობის ტიპი
                    მიიღება.
                </li>
                <li>
                    ზმნის პირის ნიშნების პარადიგმის ზტრიქონები: ზმნის
                    მრავლობითობა, ზმნის პირის პარადიგმა, პირი, რიცხვი.
                </li>
                <li>
                    ზმნის ტიპისა და პოზიციის მიხედვით აქტანტის ტიპის განსაზღვრა.
                </li>
            </ul>
