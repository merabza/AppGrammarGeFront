...
import type { IIssueDetailLine } from "../redux/types/issuesTypes";
                        ...
                        <LinkColumn
                            ...
                            onClick={(record, index, offset, showRows) => {
                                ...
                                saveIssueDetailLine({
                                    issueId: issId,
                                    detailsName:
                                        issueDetailTypes.derivationBranches,
                                    isdId: record.isdId,
                                    index,
                                    offset,
                                    showRows,
                        ...
                        <CustomColumn
                            onGetCell={(
                                ...
                                if (
                                    ...
                                    return record.roots.map(
                                        (rootItem: any, indx: number) => {
                                            return (
                                                <span key={indx}>
                                                    {indx > 0 && "; "}
                                                    <Link
